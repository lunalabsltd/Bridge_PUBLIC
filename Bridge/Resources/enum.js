        ...
        statics: {
            methods: {
                ...
                toObject: function (enumType, value) {
                    ...
                    return System.Enum.parse(enumType, value.toString(), false, true);
                },
                    ...
                    if (s != null) {
                        ...
                        if (!enumType.prototype || !enumType.prototype.$flags) {
                            for (var i = 0; i < names.length; i++) {
                                ...
                                if (System.Enum.nameEquals(name, s, ignoreCase)) {
                            ...
                            for (var i = parts.length - 1; i >= 0; i--) {
                                ...
                                for (var n = 0; n < names.length; n++) {
                                    ...
                                    if (System.Enum.nameEquals(name, part, ignoreCase)) {
                                        value |= values[name];
                                        found = true;
                    ...
                    if (((!enumType.prototype || !enumType.prototype.$flags) && forceFlags !== true) || (value === 0)) {
                        for (var i = 0; i < names.length; i++) {
                            ...
                            if (isLong && System.Int64.is64Bit(values[name]) ? (values[name].eq(value)) : (values[name] === value)) {
                                return System.Enum.toName(name);
                            }
                        }
                ...
                getNames: function (enumType) {
                    ...
                    for (var i in values) {
                        if (values.hasOwnProperty(i) && i.indexOf("$") < 0 && typeof values[i] !== "function") {
                            parts.push([System.Enum.toName(i), values[i]]);
                        }
                    }
                ...
                isDefined: function (enumType, value) {
                    ...
                    for (var i = 0; i < names.length; i++) {
                        ...
                        if (isString ? System.Enum.nameEquals(name, value, false) : (isLong ? value.eq(values[name]) : (values[name] === value))) {
                            return true;
                        }
                    }
                ...
                tryParse: function (enumType, value, result, ignoreCase) {
                    result.v = Bridge.unbox(System.Enum.parse(enumType, value, ignoreCase, true), true);
